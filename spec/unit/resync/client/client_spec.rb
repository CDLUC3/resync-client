...
module Resync
  describe Client do
    before(:each) do
      @faraday_client = instance_double(Faraday)
      @client = Client.new(faraday_client: @faraday_client)
    end
    ...
    describe '#get' do
      it 'retrieves a CapabilityList' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/capability-list.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ChangeDump' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/change-dump.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ChangeDumpManifest' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/change-dump-manifest.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ChangeList' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/change-list.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ResourceDump' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/resource-dump.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ResourceDumpManifest' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/resource-dump-manifest.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ResourceList' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/resource-list.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a SourceDescription' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/source-description.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ChangeListIndex' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/change-list-index.xml') { data }
        doc = client.get(uri)
      ...
      it 'retrieves a ResourceListIndex' do
        ...
        expect(@faraday_client).to receive(:get).with('http://example.org/resource-list-index.xml') { data }
        doc = client.get(uri)
